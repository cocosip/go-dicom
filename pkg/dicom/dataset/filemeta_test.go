...
func TestFileMetaInformationSetAndGet(t *testing.T) {
	...
	testInstanceUID := testMediaStorageSOPInstanceUID
...
func TestFileMetaInformationValidate(t *testing.T) {
	...
	fmi := NewDefaultFileMetaInformation()
	_ = fmi.SetMediaStorageSOPClassUID(testSOPClassUID)
	_ = fmi.SetMediaStorageSOPInstanceUID(testMediaStorageSOPInstanceUID)
	...
	_ = fmi3.SetMediaStorageSOPClassUID(testSOPClassUID)
	_ = fmi3.SetMediaStorageSOPInstanceUID(testMediaStorageSOPInstanceUID)
...
func TestNewFileMetaInformationFromMainDataset(t *testing.T) {
	...
	_ = ds.Add(element.NewString(tag.SOPInstanceUID, vr.UI, []string{testMediaStorageSOPInstanceUID}))
	...
	} else if sopClassUID != testSOPClassUID {
	...
	} else if sopInstanceUID != testMediaStorageSOPInstanceUID {
...
func TestNewFileMetaInformationFromMainDatasetMissingUID(t *testing.T) {
	...
	ds2 := New()
	_ = ds2.Add(element.NewString(tag.SOPClassUID, vr.UI, []string{testSOPClassUID}))
