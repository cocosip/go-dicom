...
func TestIsValid(t *testing.T) {
	tests := []struct {
		...
		{"VM1_2 with 1", vm.VM12, 1, true},
		{"VM1_2 with 2", vm.VM12, 2, true},
		{"VM1_2 with 3", vm.VM12, 3, false},
		{"VM1_n with 1", vm.VM1N, 1, true},
		{"VM1_n with 100", vm.VM1N, 100, true},
		{"VM1_n with 0", vm.VM1N, 0, false},
		{"VM2_2n with 2", vm.VM22N, 2, true},
		{"VM2_2n with 4", vm.VM22N, 4, true},
		{"VM2_2n with 6", vm.VM22N, 6, true},
		{"VM2_2n with 3", vm.VM22N, 3, false},
		{"VM2_2n with 1", vm.VM22N, 1, false},
		{"VM3_3n with 3", vm.VM33N, 3, true},
		{"VM3_3n with 6", vm.VM33N, 6, true},
		{"VM3_3n with 9", vm.VM33N, 9, true},
		{"VM3_3n with 4", vm.VM33N, 4, false},
		{"VM3_3n with 2", vm.VM33N, 2, false},
	}
