...
func TestModalityRescaleLUT(t *testing.T) {
	...
	lut := lut.NewModalityRescaleLUT(2.0, 10.0, 0, 100)
...
func TestModalitySequenceLUT(t *testing.T) {
	...
	lut := lut.NewModalitySequenceLUT(lutData, 0, false)
...
func TestCompositeLUT(t *testing.T) {
	...
	modalityLUT := lut.NewModalityRescaleLUT(2.0, 0, 0, 100)
